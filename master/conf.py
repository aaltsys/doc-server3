# -*- coding: utf-8 -*-
#
# AAltsys Server 3.0 documentation build configuration file, created by
...
htmlhelp_basename = 'AAltsysServer30doc'
...
latex_documents = [
  ('index', 'AAltsysServer30.tex', u'AAltsys Server 3.0 Documentation',
...
man_pages = [
    ('index', 'aaltsysserver30', u'AAltsys Server 3.0 Documentation',
     [u'Gerald Lovel'], 1)
]
...
texinfo_documents = [
  ('index', 'AAltsysServer30', u'AAltsys Server 3.0 Documentation',
   u'Gerald Lovel', 'AAltsysServer30', 'One line description of project.',
   'Miscellaneous'),
]
