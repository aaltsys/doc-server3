...
ECHO              Ё                                           Ё
ECHO              Ё  Another session of ATLAS is running.     Ё
ECHO              Ё                                           Ё
ECHO              Ё  Please use the running session instead   Ё
ECHO              Ё                                           Ё
ECHO              Ё  of trying to start ATLAS again.          Ё
ECHO              Ё                                           Ё
ECHO              Ё      ( or DEL \ATLAS\ATLAS.LCK )          Ё
ECHO              Ё                                           Ё
